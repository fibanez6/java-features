 ...
 */
public class StopSuspendResume2 extends Thread {
    private boolean suspended = false;

    /**
     * It is a good idea to rely on the interruption technique of a thread to stop it prematurely.
     */
    ...
    public static void main(String[] args) {
        StopSuspendResume2 t = new StopSuspendResume2();
        // Start the thread
        t.start();
        // Sleep for 2 seconds
        try {
