...
/**
 * ava has support for asynchronous socket operations such as connect, read, and write. The asynchronous socket
 * operations are performed using the following two socket channel classes:
 * <p>
 * - java.nio.channels.AsynchronousServerSocketChannel
 * - java.nio.channels.AsynchronousSocketChannel
 * <p>
 * An AsynchronousServerSocketChannel serves as a server socket that listens for new incoming client connections.
 * Once it accepts a new client connection, the interaction between the client and the server is handled by an
 * AsynchronousSocketChannel at both ends.
 */
